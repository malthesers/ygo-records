...
export default function RecentEventCard({ event }: RecentEventCardProps) {
  return (
    ...
    // </Link>
    <Link href='/' className='no-underline'>
      <article className='grid grid-cols-12 grid-rows-7 text-center'>
        <Image
          ...
          height={120}
        />
        <div className='bg-sky-900 p-2 pl-12 col-start-4 col-end-13 row-start-2 row-end-7 flex flex-col justify-center duration-200 hover:bg-sky-950'>
          {/* <p className='font-semibold'>{event.type.name}</p> */}
          <p>{event.location}</p>
          <p>
